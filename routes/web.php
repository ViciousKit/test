...
Route::get('/chat/colors', [ChatController::class, 'getChatTextColors']);
Route::middleware('auth:sanctum')->post('/chat/setColor', [ChatController::class, 'setUserChatTextColor']);
